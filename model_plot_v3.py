...
#### Individual blurred
e1 =  10**(-10.940--10.391)   ;   print e1, " + ", np.sqrt(e1**(2.0)*(0.067**2.0) + e1**(2.0)*(0.173**2.0)), " / - ", np.sqrt(e1**(2.0)*(0.177**2.0) + e1**(2.0)*(0.056**2.0))
e2 =  10**(-11.013--10.231)   ;   print e2, " + ", np.sqrt(e2**(2.0)*(0.111**2.0) + e2**(2.0)*(0.018**2.0)), " / - ", np.sqrt(e2**(2.0)*(0.135**2.0) + e2**(2.0)*(0.033**2.0))
e3 =  10**(-11.062--10.355)   ;   print e3, " + ", np.sqrt(e3**(2.0)*(0.183**2.0) + e3**(2.0)*(0.110**2.0)), " / - ", np.sqrt(e3**(2.0)*(0.575**2.0) + e3**(2.0)*(0.108**2.0))
